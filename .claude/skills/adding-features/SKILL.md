...
<script lang="ts">
	...
	let { title, variant = 'primary', disabled = false, onclick }: Props = $props()
</script>

<button class="new-component {variant}" {disabled} {onclick}>
	{title}
</button>
...
<main class="screen">
	...
	{:else}
		...
		<LumiButton onclick={navigateHome}>Voltar</LumiButton>
	{/if}
</main>
